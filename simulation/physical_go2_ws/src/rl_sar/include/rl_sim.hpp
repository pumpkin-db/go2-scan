...
#if defined(USE_ROS1)
    bool auto_getup = false;
    bool auto_getup_sent = false;
    bool model_state_received = false;
    double auto_getup_settle_seconds = 1.0;
    double auto_getup_max_body_z = 0.20;
    std::map<std::string, bool> joint_state_received;
    std::chrono::steady_clock::time_point auto_getup_ready_since;
#endif
